...
# python run.py --world_size=$world_size --task=$task --seed=1 --reducer=$reducer --comp_ratio=0.001 --rank=${RANK}
###############################
...
# if ((${RANK} == 0)); then rm -f ${DIST_INIT}; fi
# python run.py --world_size=$world_size --task=$task --seed=1 --reducer=$reducer --k_low=0.001 --k_high=0.01  --rank=${RANK}
#############################################################################################################################################
